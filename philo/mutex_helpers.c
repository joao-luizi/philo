...
/*   Updated: 2025/03/27 10:52:29 by joaomigu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
	...
	@brief Safely retrieves a value from a source location while holding a mutex 
	lock.
	This function locks the provided mutex,
		copies the value from the source location
	to the destination location,
		and then unlocks the mutex. If the mutex lock or
	unlock operations fail,
	...
	@param type The type of data being retrieved (e.g. TYPE_BOOL, TYPE_INT,
		etc.).
...
/**
	...
	@brief Safely sets a value at a destination location while holding a mutex 
	lock.
	This function locks the provided mutex,
		copies the value from the source location
	to the destination location,
...
/**
	@brief Safely increments a value at a destination location while holding a 
	mutex lock.
	This function locks the provided mutex,
		increments the value at the destination
	location,
		and then unlocks the mutex. If the mutex lock or unlock operations 
		fail,
	an error message is printed and the function returns false. Only integer 
	types
